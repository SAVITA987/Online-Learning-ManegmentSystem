...
export class ProfessorlistComponent implements OnInit {
  ...
  constructor(private _service : ProfessorService,private router:Router) { }
  ...
  public deleteProfile(professorid: string){
    this._service.deleteProfessorById(professorid).subscribe(
      (Response)=>{

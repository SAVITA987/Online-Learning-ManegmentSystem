...
{	
	...
	@GetMapping("/professorById/{professorId}")
	
	public ResponseEntity <Professor> getprofessorById(@PathVariable String professorId) throws Exception
	{
	...
	@DeleteMapping("/deleteByPId/{professorid}")
	public List<Professor> deleteProfessorById(@PathVariable String professorid)throws Exception{
